...
export const popupwin = require("./popup-win.png")
export const ttbv = require("./ttbv.png")
export const ahsbv = require("./ahsbv.png")
export const tak = require("./tak.png")
export const rule1 = require("./rule1.png")
export const rule2 = require("./rule2.png")
export const prev = require("./prev.png")
export const nextbtn = require("./nextbtn.png")
export const tinh = require("./tinh.png")
export const caymai = require("./caymai.png")
