...
const Readyfightscrew = () => {
  ...
  useEffect(() => {
    ...
    coundown === 2 ? history.push('./fightscrew') : '';
    return () => clearInterval(timerId);
  });
  const handleFind = () => {
    history.push('/screwfight');
  };
  const handleBack = () => {
    history.push('/lixi');
  };
  return (
    <AnimatedPage>
      <div className="main-readyfightscrew">
        <Button handleClick={handleBack} icon={arrow}></Button>
        <span className="main-readyfightscrew__timer">00:{coundown}</span>
        <div className="main-readyfightscrew__button">
...
export default Readyfightscrew;
